...
function(lang, on, registry, stamp){
	...
	return {
		...
		//	onResult = on(this.unloadSimple, "click", lang.hitch(this, function(e){
			...
			//	var view = this.parent.children.swapViewTestApp_simple;
		//		this.app.unloadView(this.parent.children.swapViewTestApp_simple, this.unloadCallback);
			//	view = null;
			/*
				var params = {};
		...
		//	onResult = on(this.unloadList, "click", lang.hitch(this, function(e){
			//	var view = this.parent.children.swapViewTestApp_listMain;
		//		this.app.unloadView(this.parent.children.swapViewTestApp_listMain, this.unloadCallback);
			//	view = null;
			/*
				var params = {};
				params.parent = this.parent;
